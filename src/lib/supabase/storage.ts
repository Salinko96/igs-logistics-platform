...
import type { File as NodeFile } from 'node:fs';
 ...
 */
export async function uploadFile(caseId: string, file: { name: string; type: string; data: Buffer | NodeFile }): Promise<string> {
