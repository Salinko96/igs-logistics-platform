...
export default function CookiesPage() {
  return <LegalPage title="Politique relative aux cookies" description="Cookies strictement nécessaires, préférences et mesure d’audience optionnelle sur IGS Nexus.">
    ...
    <LegalSection title="Durée du choix"><p>Votre préférence est conservée pendant six mois. Pour la modifier avant son expiration, supprimez le cookie « igs-cookie-consent » dans les réglages de confidentialité de votre navigateur, puis rechargez IGS Nexus.</p></LegalSection>
